...
\skillentry {
  ...
  &\bullet\space \textbf{Generating Synthetic Summarized Titles From Indian News Reports, Using Python NLTK}
  \\% AI, NLP
  \href{https://github.com/ph504/StudentSuccessLikelihood}{\textcolor{cobalt}{[github]}} \hspace{0.1 cm}
  &\bullet\space \textbf{Likelihood Calculation with multiple ML Approaches for Student Success Based on Engineered Dataset}
  \\% AI, Data
