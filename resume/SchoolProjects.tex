...
\skillentry {
  ...
  &\bullet\space \textbf{Likelihood Calculation with multiple ML Approaches for Student Success Based on Engineered Real-World Dataset}
  \\% AI, Data
  \href{https://github.com/ph504/NewsSummarization}{\textcolor{cobalt}{[github]}} \hspace{0.1 cm}
  &\bullet\space \textbf{Generating Synthetic Summarized Titles From Indian News Reports, Using Python NLTK Based on Real-World Dataset from Kaggle}
  \\% AI, NLP
  ...
  &\bullet\space \textbf{Classification of Different Car Brand Models, Using CNNs and Webscraping with Python Keras}
  \\% AI, Vision
