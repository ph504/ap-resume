...
\begin{cventries}
    ...
    {Applied UI/UX principles to Teleoperation interfaces, in order to achieve better user performance and experience. Implemented automation for robot network configuration. \newline Used ROS and tkinter along with Python3 to develope the interface and operate the robot}
    \vspace{0.4 cm}
\end{cventries}
